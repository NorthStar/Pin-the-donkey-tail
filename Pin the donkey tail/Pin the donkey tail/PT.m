...
- (id) initWithTagQuery:(NSString *)query andTarget:(id)incomingTarget andAction:(SEL)incomingAction
{
    ...
    if (self) {
         ...
         */
        self.connection = [[NSURLConnection alloc] initWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://api.pinterest.com/v3/search/pins/?query=%@donkeys&page_size=25&client_id=1435791&timestamp=1390674537047&oauth_signature=dbb218731dc6c0bd8c394185f1a82d6011e9ddab3871628d4ebcb3afaad79f12", query]]] delegate:self];
